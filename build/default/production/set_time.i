...
void blink(unsigned short int field_select)
{
    ...
    else
    {
        ...
        clcd_putch((set_hr / 10) + 48, (0xC0 + (4)));
        clcd_putch((set_hr % 10) + 48, (0xC0 + (5)));
        clcd_putch((set_min / 10) + 48, (0xC0 + (7)));
        clcd_putch((set_min % 10) + 48, (0xC0 + (8)));
        clcd_putch((set_sec / 10) + 48, (0xC0 + (10)));
        clcd_putch((set_sec % 10) + 48, (0xC0 + (11)));
...
void set_time(void)
{
    ...
    {
        write_ds1307(0x02, (((set_hr / 10) << 4) | (set_hr % 10)));
        write_ds1307(0x01, (((set_min / 10) << 4) | (set_min % 10)));
        write_ds1307(0x00, (((set_sec / 10) << 4) | (set_sec % 10)));
        clcd_print("TIME UPDATED",(0x80 + (0)));
