...
void display_time(void)
{
    ...
    clcd_putch(((hr / 10) + 48), (0xC0 + (0)));
    clcd_putch(((hr % 10) + 48), (0xC0 + (1)));
    clcd_putch(':', (0xC0 + (2)));


    clcd_putch(((min / 10) + 48), (0xC0 + (3)));
    clcd_putch(((min % 10) + 48), (0xC0 + (4)));
    clcd_putch(':', (0xC0 + (5)));


    clcd_putch(((sec / 10) + 48), (0xC0 + (6)));
...
void view_dashboard(void)
{
    ...
    if(key != 0xFF)
    {
        if(key == 1)
        {
            ...
            clcd_print(gear[gear_index], (0xC0 + (10)));
            collision_flag = 0;
        }
        else if(key == 2)
        {
