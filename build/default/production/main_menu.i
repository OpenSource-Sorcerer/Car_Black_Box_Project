...
void display_main_menu(void)
{
    ...
    if(!limit)
    {
        ...
        clcd_print("   DOWNLOAD LOG", (0xC0 + (0)));
    }
    if(key == 1)
    {
        clcd_write(0x01, 0);
        ...
        if(limit > 0)
        {
            clcd_print(logs[limit],(0x80 + (3)));
            clcd_print(logs[limit + 1],(0xC0 + (3)));
        }
    }
    else if(key == 2)
    {
        ...
        if(limit > 0)
        {
            clcd_print(logs[limit - 1],(0x80 + (3)));
            clcd_print(logs[limit],(0xC0 + (3)));
        }
    }
    else if(key == 11)
    {
        ...
        switch(limit)
        {
            ...
            case 3:
                ...
                clock_reg1[0] = read_ds1307(0x02);
                clock_reg1[1] = read_ds1307(0x01);
                clock_reg1[2] = read_ds1307(0x00);
